...
from models.shared_encoders import (
    ...
    ChannelSharedPosResAttentionV3NoIdentity,
    ChannelSharedPosResAttentionV3NoResidual,
    ChannelSharedPosResAttentionV3ResidualOnlyMLP,
    ChannelSharedPosResMeanPoolV3NoAttention,
...
MODEL_REGISTRY: dict[str, ModelFactory] = {
    ...
    "channel_shared_posres_attention_v3_no_residual": ChannelSharedPosResAttentionV3NoResidual,
    "channel_shared_posres_attention_v3_residual_only_mlp": ChannelSharedPosResAttentionV3ResidualOnlyMLP,
    "channel_shared_posres_attention_v3_no_identity": ChannelSharedPosResAttentionV3NoIdentity,
    "channel_shared_posres_meanpool_v3_no_attention": ChannelSharedPosResMeanPoolV3NoAttention,
